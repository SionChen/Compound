...
- (void)viewDidLoad {
    ...
    self.imageView.image = [self addImage:[UIImage imageNamed:@"MessageServerCenter"] toImage:[UIImage imageNamed:@"MessageSystem"]];
...
- (UIImage *)addImage:(UIImage *)addImage toImage:(UIImage *)toImage {
    ...
    // Draw image1
    [toImage drawInRect:CGRectMake(drawSize.width/2-toImage.size.width/2, 0, toImage.size.width, toImage.size.height)];
    
    // Draw image2
    [addImage drawInRect:CGRectMake(drawSize.width/2-addImage.size.width/2, toImage.size.height, addImage.size.width, addImage.size.height)];
